...
<body>
    ...
    <form action="${pageContext.request.contextPath}/provide/edit/${provideItem.id}" method="post" enctype="multipart/form-data">
        <div class="content-wrapper">
            <div class="left-half">
                <div class="image-upload-area">
                    <c:choose>
                        <c:when test="${not empty provideItem.imagePath}">
                            <img src="${provideItem.imagePath}" alt="Current Image" style="max-width: 100%; max-height: 100%; object-fit: contain;">
                        </c:when>
                        <c:otherwise>
            ...
            <div class="right-half">
                <div class="form-group">
                    ...
                    <input type="text" id="goodsName" name="goodsName" value="${provideItem.goodsName}" placeholder="굿즈 이름을 입력하세요">
                </div>
                <div class="form-group">
                    <label for="goodsDescription">굿즈 설명</label>
                    <textarea id="goodsDescription" name="goodsDescription" placeholder="굿즈 설명을 입력하세요" rows="1">${provideItem.goodsDescription}</textarea>
                </div>
                <div class="form-group">
                    <label for="price">가격</label>
                    <input type="number" id="price" name="price" value="${provideItem.price}" placeholder="가격을 입력하세요" step="1" min="0">
                </div>
                <div class="form-group">
                    <label>현장 거래</label>
                    <div class="radio-group">
                        <input type="radio" id="tradePossible" name="inPersonTransaction" value="true" ${provideItem.inPersonTransaction ? 'checked' : ''}>
                        <label for="tradePossible">가능</label>
                        <input type="radio" id="tradeImpossible" name="inPersonTransaction" value="false" ${!provideItem.inPersonTransaction ? 'checked' : ''}>
